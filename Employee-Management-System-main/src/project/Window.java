...
public class Window {
	...
	private void initialize() {
        ...
        try {
            frmEmployeeManagementSystem.setIconImage(
                new ImageIcon(getClass().getResource("/project/employee.png")).getImage());
        } catch (Exception e) {
		...
		addbtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					JOptionPane.showMessageDialog(frmEmployeeManagementSystem, "Salary Must be Number not Alphabet",
							"Error", JOptionPane.ERROR_MESSAGE);
				}
			}
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (op.updateEmp(em)) {
						...
						JOptionPane.showMessageDialog(frmEmployeeManagementSystem, "Some Error Occured !!", "Error",
	...
	private void cleartxts() {
        deletebtn.setEnabled(false);
        updatebtn.setEnabled(false);
        idtxt.setText("....."); // Consistent with initial value
